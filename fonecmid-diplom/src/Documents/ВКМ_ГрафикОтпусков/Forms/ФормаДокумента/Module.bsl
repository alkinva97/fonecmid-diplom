...
Процедура ДиаграммаГанта(Команда)
	...
	П = СформироватьАдресВоВременномХранилище();
	ОткрытьФорму("Документ.ВКМ_ГрафикОтпусков.Форма.ФормаАнализГрафика", П);
...
Функция СформироватьАдресВоВременномХранилище()
	...
	П = Новый Структура;
	П.Вставить("ЗначенияЗаполнения", ЗначенияЗаполнения); 
