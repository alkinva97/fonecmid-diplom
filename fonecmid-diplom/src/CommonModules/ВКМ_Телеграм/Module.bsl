...
Процедура ОтправитьСообщение() Экспорт
	...
	//Константы.ВКМ_ТокенУправленияТелеграмБотом.Установить("7871879132:AAGl5c3y-_HJHfgdsx-byzILqM-Zsy9GWUI");
	//Константы.ВКМ_ИдентификаторГруппыДляОповещения.Установить("-4876844248");
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Попытка
			...
			Если Ответ.КодСостояния = 200 Тогда
				ЗаписьЖурналаРегистрации("Отправка успешна", УровеньЖурналаРегистрации.Примечание);
			КонецЕсли;
			
		Исключение
			ЗаписьЖурналаРегистрации("Ошибка при отправке", УровеньЖурналаРегистрации.Ошибка, , 
